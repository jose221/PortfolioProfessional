...
-- Tiempo de generación: 26-09-2022 a las 09:22:23
...
--
-- Base de datos: `herandr1_portafolio_db`
--
CREATE DATABASE IF NOT EXISTS `herandr1_portafolio_db` DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci;
USE `herandr1_portafolio_db`;
...
CREATE TABLE `history_curriculum_vitae` (
  `id` bigint(20) UNSIGNED NOT NULL,
...
CREATE TABLE `knowledges_abilities` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `title_es` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `title_en` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `description_es` longtext COLLATE utf8mb4_unicode_ci,
...
CREATE TABLE `prefessional_experiences` (
  `id` bigint(20) UNSIGNED NOT NULL,
...
CREATE TABLE `styleguide_basics` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
...
CREATE TABLE `styleguide_patterns` (
  `id` bigint(20) UNSIGNED NOT NULL,
...
INSERT INTO `users` (`id`, `name`, `age`, `date_birthday`, `nationality_es`, `nationality_en`, `description_es`, `description_en`, `email`, `email_verified_at`, `password`, `country_es`, `country_en`, `header_image_path`, `my_perfil`, `logo`, `slogan_es`, `slogan_en`, `avatar`, `header_text_es`, `header_text_en`, `remember_token`, `created_at`, `updated_at`, `cv`) VALUES
(1, 'José Ángel Alvarado Gonzalez', 22, '1999-04-25', 'Mexicana', 'Mexican', 'Soy ingeniero en tecnologías de la información y comunicación. Egresado de la universidad Tecnológica de Cancún, soy apasionado a la ciencia y las tecnologías, Me considero persona que cuenta con gran capacidad para adaptarme a equipos y especializada en programación y el desarrollo de aplicaciones móviles. Siempre busco la mejor forma de encontrar soluciones a los problemas.', 'I am an engineer in information and communication technologies. Graduated from the Technological University of Cancun, I am a person passionate about technology and science, I consider myself a person who has great ability to adapt to teams and specialized in programming and the development of mobile applications . I always look for the best way to find solutions to problems.', 'jose.alvarado220@hotmail.com', NULL, '$2y$10$Gd/cHIJO/o4.eVsFKuJhHO.n9fFdp6ZEGUcYP8dkkG5JlwUc7DWMS', 'Cancún Quintana Roo', 'Cancún Quintana Roo', '/storage/3RqrIPF0fBI1JNGIJ3G0FlR4YnexhIQVCK3xYpJK.webp', '/storage/csV5eKMsKrrfvbdJgeQh9ktpHLUlYOIDa7u8u8OT.webp', '/storage/hzp5qE4l99HGtHYLkDvyDsLyxtHA0QX6g8wzPyfX.svg', '/storage/vFkeUrshO8RmAxLgS4gRDneKdzwegtdU5FkbfX7n.svg', '/storage/IzCHVYthqd8kyZooKIsEpDH28wEOjPJTO7ZqrR3W.svg', NULL, 'Desarrollador de aplicaciones multiplataforma', 'Cross-platform application developer', 'BCqgSWOmNzvUqYjlqoU3IYxDNZYDJbdWseMOxON2aMueWaaaC81ttfgQFluO', '2021-09-06 16:51:15', '2022-07-21 06:51:25', 13);
...
--
-- Indices de la tabla `history_curriculum_vitae`
--
ALTER TABLE `history_curriculum_vitae`
  ADD PRIMARY KEY (`id`);
...
ALTER TABLE `knowledges`
  ADD PRIMARY KEY (`id`),
  ADD KEY `knowledges_user_id_foreign` (`user_id`);

--
-- Indices de la tabla `knowledges_abilities`
--
ALTER TABLE `knowledges_abilities`
  ADD PRIMARY KEY (`id`),
  ADD KEY `knowledges_abilities_knowledges_id_foreign` (`knowledges_id`);
...
--
-- Indices de la tabla `my_contacts`
--
ALTER TABLE `my_contacts`
  ADD PRIMARY KEY (`id`),
  ADD KEY `my_contacts_user_id_foreign` (`user_id`);
...
--
-- Indices de la tabla `personal_projects`
--
ALTER TABLE `personal_projects`
  ADD PRIMARY KEY (`id`),
  ADD KEY `personal_projects_user_id_foreign` (`user_id`);
...
ALTER TABLE `portfolios`
  ADD PRIMARY KEY (`id`),
  ADD KEY `portfolios_portfolio_categories_id_foreign` (`portfolio_categories_id`);
...
--
-- Indices de la tabla `prefessional_experiences`
--
ALTER TABLE `prefessional_experiences`
  ADD PRIMARY KEY (`id`),
  ADD KEY `prefessional_experiences_user_id_foreign` (`user_id`);
...
--
-- Indices de la tabla `styleguide_basics`
--
ALTER TABLE `styleguide_basics`
  ADD PRIMARY KEY (`id`);

--
-- Indices de la tabla `styleguide_colors`
--
ALTER TABLE `styleguide_colors`
  ADD PRIMARY KEY (`id`);

--
-- Indices de la tabla `styleguide_patterns`
--
ALTER TABLE `styleguide_patterns`
  ADD PRIMARY KEY (`id`);
...
ALTER TABLE `users`
  ...
  ADD KEY `FK_users_history_curriculum_vitae` (`cv`);
...
--
-- AUTO_INCREMENT de la tabla `history_curriculum_vitae`
--
ALTER TABLE `history_curriculum_vitae`
...
--
-- AUTO_INCREMENT de la tabla `knowledges_abilities`
--
ALTER TABLE `knowledges_abilities`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT de la tabla `my_contacts`
--
ALTER TABLE `my_contacts`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT de la tabla `personal_projects`
--
ALTER TABLE `personal_projects`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT de la tabla `prefessional_experiences`
--
ALTER TABLE `prefessional_experiences`
...
--
-- AUTO_INCREMENT de la tabla `styleguide_basics`
--
ALTER TABLE `styleguide_basics`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `styleguide_colors`
--
ALTER TABLE `styleguide_colors`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `styleguide_patterns`
--
ALTER TABLE `styleguide_patterns`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;
...
--
-- Filtros para la tabla `knowledges`
--
ALTER TABLE `knowledges`
  ADD CONSTRAINT `knowledges_user_id_foreign` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Filtros para la tabla `knowledges_abilities`
--
ALTER TABLE `knowledges_abilities`
  ADD CONSTRAINT `knowledges_abilities_knowledges_id_foreign` FOREIGN KEY (`knowledges_id`) REFERENCES `knowledges` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Filtros para la tabla `my_contacts`
--
ALTER TABLE `my_contacts`
  ADD CONSTRAINT `my_contacts_user_id_foreign` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Filtros para la tabla `personal_projects`
--
ALTER TABLE `personal_projects`
  ADD CONSTRAINT `personal_projects_user_id_foreign` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Filtros para la tabla `portfolios`
--
ALTER TABLE `portfolios`
  ADD CONSTRAINT `portfolios_portfolio_categories_id_foreign` FOREIGN KEY (`portfolio_categories_id`) REFERENCES `portfolio_categories` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Filtros para la tabla `prefessional_experiences`
--
ALTER TABLE `prefessional_experiences`
  ADD CONSTRAINT `prefessional_experiences_user_id_foreign` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Filtros para la tabla `studies`
--
ALTER TABLE `studies`
  ADD CONSTRAINT `studies_user_id_foreign` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Filtros para la tabla `users`
--
ALTER TABLE `users`
  ADD CONSTRAINT `FK_users_history_curriculum_vitae` FOREIGN KEY (`cv`) REFERENCES `history_curriculum_vitae` (`id`) ON DELETE SET NULL ON UPDATE SET NULL;
COMMIT;
