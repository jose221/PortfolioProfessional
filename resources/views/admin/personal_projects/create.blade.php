...
@section('content')
    ...
    @endif
    <form method="post" class="row" action="{{route('project.personal.store')}}"  enctype="multipart/form-data">
        @csrf
        <div class=" col-md-12">
            <div class="card mb-3">
        ...
        <div class="col-md-6">
            <div class="form-group">
                ...
                <input type="date" class="form-control" id="date_upload" name="date_upload" aria-describedby="date_upload-help">
        ...
        <div class="col-md-6">
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="link" name="link" aria-describedby="link-help">
